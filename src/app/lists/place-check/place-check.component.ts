...
@Component({
  ...
  templateUrl: './place-check.component.html',
  styleUrls: ['./place-check.component.css']
})
export class PlaceCheckComponent implements OnInit {
  IsErr: boolean = false;
  ...
  constructor(
    private listService: PlaceCheckService,
  ...
  initForm(){
    this.shared.setNameList('Обстоятельства выявления')
