...
import { ArvtService } from 'src/app/services/lists-services/arvt.service';

@Component({
  selector: 'app-arvt',
  templateUrl: './arvt.component.html',
  styleUrls: ['./arvt.component.css']
})
export class ArvtComponent implements OnInit {
  IsErr: boolean = false;
  ...
  constructor(
    private listService: ArvtService,
