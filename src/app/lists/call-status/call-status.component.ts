...
import { CallStatusService } from 'src/app/services/lists-services/call-status.service';
...
export class CallStatusComponent implements OnInit {
  ...
  constructor(
    private listService: CallStatusService,
  ...
  initForm(){
    this.shared.setNameList('Статус звонка')
