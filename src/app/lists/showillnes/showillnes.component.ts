...
import { ShowillnesService } from 'src/app/services/lists-services/showillnes.service';

@Component({
  selector: 'app-showillnes',
  templateUrl: './showillnes.component.html',
  styleUrls: ['./showillnes.component.css']
})
export class ShowillnesComponent  implements OnInit {
  IsErr: boolean = false;
  ...
  constructor(
    private listService: ShowillnesService,
  ...
  initForm(){
    this.shared.setNameList('Вторичное заболевание')
