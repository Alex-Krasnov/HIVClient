...
import { HospResultService } from 'src/app/services/lists-services/hosp-result.service';
import { ListSharedServiceService } from 'src/app/services/lists-services/list-shared-service.service';

@Component({
  selector: 'app-hosp-result',
  templateUrl: './hosp-result.component.html',
  styleUrls: ['./hosp-result.component.css']
})
export class HospResultComponent implements OnInit {
  IsErr: boolean = false;
  ...
  constructor(
    private listService: HospResultService,
  ...
  initForm(){
    this.shared.setNameList('Исход госпитализации')
