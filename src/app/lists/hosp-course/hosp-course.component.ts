...
import { HospCourseService } from 'src/app/services/lists-services/hosp-course.service';
import { ListSharedServiceService } from 'src/app/services/lists-services/list-shared-service.service';

@Component({
  selector: 'app-hosp-course',
  templateUrl: './hosp-course.component.html',
  styleUrls: ['./hosp-course.component.css']
})
export class HospCourseComponent implements OnInit {
  IsErr: boolean = false;
  ...
  constructor(
    private listService: HospCourseService,
  ...
  initForm(){
    this.shared.setNameList('Причина госпитализации')
