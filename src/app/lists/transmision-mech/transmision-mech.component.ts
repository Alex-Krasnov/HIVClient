...
import { TransmisionMechService } from 'src/app/services/lists-services/transmision-mech.service';

@Component({
  selector: 'app-transmision-mech',
  templateUrl: './transmision-mech.component.html',
  styleUrls: ['./transmision-mech.component.css']
})
export class TransmisionMechComponent implements OnInit {
  IsErr: boolean = false;
  ...
  constructor(
    private listService: TransmisionMechService,
  ...
  initForm(){
    this.shared.setNameList('Вероятный мех. передачи')
