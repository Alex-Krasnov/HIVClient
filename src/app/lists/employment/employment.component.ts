...
import { EmploymentService } from 'src/app/services/lists-services/employment.service';
...
export class EmploymentComponent  implements OnInit {
  ...
  constructor(
    private listService: EmploymentService,
  ...
  initForm(){
    this.shared.setNameList('Занятость')
