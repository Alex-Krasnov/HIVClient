...
@Component({
  selector: 'app-cure-change',
  templateUrl: './cure-change.component.html',
  styleUrls: ['./cure-change.component.css']
})
export class CureChangeComponent implements OnInit {
  IsErr: boolean = false;
  ...
  constructor(
    private listService: CureChangeService,
