...
import { CorrespIllnesService } from 'src/app/services/lists-services/corresp-illnes.service';
import { ListSharedServiceService } from 'src/app/services/lists-services/list-shared-service.service';

@Component({
  selector: 'app-corresp-illness',
  templateUrl: './corresp-illness.component.html',
  styleUrls: ['./corresp-illness.component.css']
})
export class CorrespIllnessComponent implements OnInit {
  IsErr: boolean = false;
  ...
  constructor(
    private listService: CorrespIllnesService,
  ...
  initForm(){
    this.shared.setNameList('Сопутствующие заболевания')
