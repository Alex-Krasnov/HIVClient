...
import { CodeMKB10Service } from 'src/app/services/lists-services/code-mkb10.service';
import { ListSharedServiceService } from 'src/app/services/lists-services/list-shared-service.service';

@Component({
  selector: 'app-code-mkb10',
  templateUrl: './code-mkb10.component.html',
  styleUrls: ['./code-mkb10.component.css']
})
export class CodeMKB10Component implements OnInit {
  IsErr: boolean = false;
  ...
  constructor(
    private listService: CodeMKB10Service,
  ...
  initForm(){
    this.shared.setNameList('Кодировка МКБ 10')
