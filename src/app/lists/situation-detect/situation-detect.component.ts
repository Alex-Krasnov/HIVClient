...
import { SituationDetectService } from 'src/app/services/lists-services/situation-detect.service';

@Component({
  selector: 'app-situation-detect',
  templateUrl: './situation-detect.component.html',
  styleUrls: ['./situation-detect.component.css']
})
export class SituationDetectComponent implements OnInit {
  IsErr: boolean = false;
  ...
  constructor(
    private listService: SituationDetectService,
  ...
  initForm(){
    this.shared.setNameList('Место выявления')
