...
import { RangeTherapyService } from 'src/app/services/lists-services/range-therapy.service';

@Component({
  selector: 'app-range-therapy',
  templateUrl: './range-therapy.component.html',
  styleUrls: ['./range-therapy.component.css']
})
export class RangeTherapyComponent implements OnInit {
  IsErr: boolean = false;
  ...
  constructor(
    private listService: RangeTherapyService,
  ...
  initForm(){
    this.shared.setNameList('Ряд терапии')
