...
import { InfectCourseService } from 'src/app/services/lists-services/infect-course.service';
import { ListSharedServiceService } from 'src/app/services/lists-services/list-shared-service.service';

@Component({
  selector: 'app-infect-course',
  templateUrl: './infect-course.component.html',
  styleUrls: ['./infect-course.component.css']
})
export class InfectCourseComponent  implements OnInit {
  IsErr: boolean = false;
  ...
  constructor(
    private listService: InfectCourseService,
  ...
  initForm(){
    this.shared.setNameList('Причина заражения')
