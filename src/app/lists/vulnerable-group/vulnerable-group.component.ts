...
import { VulnerableGrupService } from 'src/app/services/lists-services/vulnerable-grup.service';

@Component({
  selector: 'app-vulnerable-group',
  templateUrl: './vulnerable-group.component.html',
  styleUrls: ['./vulnerable-group.component.css']
})
export class VulnerableGroupComponent implements OnInit {
  IsErr: boolean = false;
  ...
  constructor(
    private listService: VulnerableGrupService,
  ...
  initForm(){
    this.shared.setNameList('Кат. уязвимой группы')
