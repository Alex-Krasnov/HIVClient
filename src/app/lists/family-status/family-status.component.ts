...
import { FamilyStatusService } from 'src/app/services/lists-services/family-status.service';
...
export class FamilyStatusComponent implements OnInit {
  ...
  constructor(
    private listService: FamilyStatusService,
  ...
  initForm(){
    this.shared.setNameList('Семейное положение')
