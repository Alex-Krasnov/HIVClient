...
import { DiagnosisService } from 'src/app/services/lists-services/diagnosis.service';
import { ListSharedServiceService } from 'src/app/services/lists-services/list-shared-service.service';
import { MedForSchemaService } from 'src/app/services/lists-services/med-for-schema.service';

@Component({
  selector: 'app-med-for-schema',
  templateUrl: './med-for-schema.component.html',
  styleUrls: ['./med-for-schema.component.css']
})
export class MedForSchemaComponent implements OnInit {
  IsErr: boolean = false;
  ...
  constructor(
    private listService: MedForSchemaService,
  ...
  initForm(){
    this.shared.setNameList('Препараты для схем')
