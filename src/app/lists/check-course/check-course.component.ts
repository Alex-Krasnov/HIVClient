...
import { CheckCourseService } from 'src/app/services/lists-services/check-course.service';

@Component({
  selector: 'app-check-course',
  templateUrl: './check-course.component.html',
  styleUrls: ['./check-course.component.css']
})
export class CheckCourseComponent  implements OnInit {
  IsErr: boolean = false;
  ...
  constructor(
    private listService: CheckCourseService,
  ...
  initForm(){
    this.shared.setNameList('Код контингента')
