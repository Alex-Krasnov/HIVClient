...
import { EpidDoctorService } from 'src/app/services/lists-services/epid-doctor.service';
import { ListSharedServiceService } from 'src/app/services/lists-services/list-shared-service.service';

@Component({
  selector: 'app-epid-doctor',
  templateUrl: './epid-doctor.component.html',
  styleUrls: ['./epid-doctor.component.css']
})
export class EpidDoctorComponent implements OnInit {
  IsErr: boolean = false;
  ...
  constructor(
    private listService: EpidDoctorService,
  ...
  initForm(){
    this.shared.setNameList('Врач проводивший расследование')
