...
import { CheckPlaceService } from 'src/app/services/lists-services/check-place.service';

@Component({
  selector: 'app-check-place',
  templateUrl: './check-place.component.html',
  styleUrls: ['./check-place.component.css']
})
export class CheckPlaceComponent implements OnInit {
  IsErr: boolean = false;
  ...
  constructor(
    private listService: CheckPlaceService,
  ...
  initForm(){
    this.shared.setNameList('МО, направ. матер.')
