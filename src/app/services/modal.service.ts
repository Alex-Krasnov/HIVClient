...
export class ModalService {
  ...
  referalAnalysisIbIsVisible$ = new BehaviorSubject<boolean>(false)
  ...
  close() {
    ...
    this.referalAnalysisIbIsVisible$.next(false)
  ...
  referalAnalysisIbOpen() { 
    this.referalAnalysisIbIsVisible$.next(true)
  }
