...
@Component({
  selector: 'app-select-die-list',
  templateUrl: './select-die-list.component.html',
  styleUrls: ['./select-die-list.component.css']
})
export class SelectDieListComponent implements OnInit{
  form: FormGroup;
  arr = new FormArray([]);
