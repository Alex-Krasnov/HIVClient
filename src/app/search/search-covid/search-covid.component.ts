...
import { SearchCovidService } from 'src/app/services/search/search-covid.service';
...
export class SearchCovidComponent  implements OnInit{
  ...
  async getSearchRes(value: SearchCovidModel){
    this.loading.open()
  ...
  async getExcel(value: SearchCovidModel){
    this.loading.open()
