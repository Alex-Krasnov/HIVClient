...
import { SearchNonresidentForm } from './search-nonresident-form.model';
import { SearchNonresidentService } from 'src/app/services/search/search-nonresident.service';
...
export class SearchNonresidentComponent  implements OnInit{
  private SearchForm: BehaviorSubject<FormGroup | undefined>
  SearchForm$: Observable<FormGroup>
  SearchFormSub: Subscription
  searchLists: SearchNonresidentModelLists
  ...
  constructor(
    private searchService: SearchNonresidentService,
  ...
  initForm(){
    this.searchService.getLists().subscribe((item: SearchNonresidentModelLists) => {
      this.searchLists = item
    })

    this.SearchForm = new BehaviorSubject(this.fb.group(new SearchNonresidentForm(this.listService)));
  ...
  setData(needXl: boolean){
    if(this.searchForm.valid){
      ...
      let formValue: SearchNonresidentModel = {
        ...
        stageDateStart: this.searchForm.controls['stageDateStart'].value,
        stageDateEnd: this.searchForm.controls['stageDateEnd'].value,
        ...
        dateDiagnosisStart: this.searchForm.controls['dateDiagnosisStart'].value,
        dateDiagnosisEnd: this.searchForm.controls['dateDiagnosisEnd'].value,
        placeDiagnosis: this.searchForm.controls['placeDiagnosis'].value,
        dateRegistrationYNA: this.searchForm.controls['dateRegistrationYNA'].value,
        dateRegistrationStart: this.searchForm.controls['dateRegistrationStart'].value,
        dateRegistrationEnd: this.searchForm.controls['dateRegistrationEnd'].value,
        dateDepartureYNA: this.searchForm.controls['dateDepartureYNA'].value,
        dateDepartureStart: this.searchForm.controls['dateDepartureStart'].value,
        dateDepartureEnd: this.searchForm.controls['dateDepartureEnd'].value,
        ...
        selectDateDiagnosis: this.searchForm.controls['selectDateDiagnosis'].value,
        selectPlaceDiagnosis: this.searchForm.controls['selectPlaceDiagnosis'].value,
        selectDateRegistration: this.searchForm.controls['selectDateRegistration'].value,
  ...
  markAll(){
    ...
    this.searchForm.controls['selectDateDiagnosis'].setValue(true)
    this.searchForm.controls['selectPlaceDiagnosis'].setValue(true)
    this.searchForm.controls['selectDateRegistration'].setValue(true)
    this.searchForm.controls['selectDateDeparture'].setValue(true)
  ...
  dismarkAll(){
    ...
    this.searchForm.controls['selectDateDiagnosis'].setValue(false)
    this.searchForm.controls['selectPlaceDiagnosis'].setValue(false)
    this.searchForm.controls['selectDateRegistration'].setValue(false)
    this.searchForm.controls['selectDateDeparture'].setValue(false)
  ...
  giveList(lst: string[]){
    switch (this.selectedList) {
      ...
      case 7:
        ...
        break
      case 8:
        this.searchForm.controls['placeDiagnosis'].setValue(lst)
        break
    }
  }
}