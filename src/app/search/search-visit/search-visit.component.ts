...
import { SearchVisitService } from 'src/app/services/search/search-visit.service';
...
export class SearchVisitComponent implements OnInit{
  ...
  async getSearchRes(value: SearchVisitModel){
    this.loading.open()
  ...
  async getExcel(value: SearchVisitModel){
    this.loading.open()
