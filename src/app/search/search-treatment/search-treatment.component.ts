...
import { SearchTreatmentService } from 'src/app/services/search/search-treatment.service';
...
export class SearchTreatmentComponent implements OnInit{
  ...
  async getSearchRes(value: SearchTreatmentModel){
    this.loading.open()
  ...
  async getExcel(value: SearchTreatmentModel){
    this.loading.open()
